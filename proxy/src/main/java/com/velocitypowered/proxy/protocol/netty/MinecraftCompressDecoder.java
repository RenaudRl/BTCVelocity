...
public class MinecraftCompressDecoder extends MessageToMessageDecoder<ByteBuf> {
  ...
  // BTC: increased from 64 to 256 for Axiom incompressible payload support
  private static final double MAX_COMPRESSION_RATIO = Double.parseDouble(System.getProperty("velocity.max-compression-ratio", "256"));
