...
package com.btcvelocity.proxy.command;
...
public class CommandUtils {
   ...
   * Will suggest {@link com.btcvelocity.api.cluster.ClusterPlayer} names through
   * {@link com.btcvelocity.proxy.cluster.VelocityClusterPlayerService#getPlayerNames()},
